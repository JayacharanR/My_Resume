...
#one-col-entry(
  content: [Aspiring data science professional with hands-on experience in analytics, and dashboard development using SAP Analytics Cloud. Eager to contribute to impactful, data-driven solutions in a dynamic engineering environment, leveraging a blend of technical expertise, analytical thinking, and a continuous learning mindset.]
)
...
#block(
  [
    #set par(spacing: 0pt)
    #v(design-highlights-top-margin);#highlights([Grade: AISSCE: 90\% , AISSE: 98\%],)
  ],
  inset: (
    left: design-entries-left-and-right-margin,
    right: design-entries-left-and-right-margin,
...
#two-col-entry(
  left-content: [
    #link("https://www.linkedin.com/in/jayacharan-r/details/experience/1751543949426/single-media-viewer/?profileId=ACoAAEdSV3MBfyjLYwsDt4rUTvxD4YvS4JxR158")[#strong[SAP Analytics Cloud, Intern]], Blueprint Technologies Pvt Ltd  -- Bengaluru, KA, India
  ],
  right-content: [
    May 2025 – July 2025
  ],
...
#one-col-entry(
  content: [
    #v(design-highlights-top-margin);#highlights([Worked in core analytics concepts including Databricks, data lakes, and responsive dashboards in SAP Analytics Cloud advanced dimension-level calculations, enhancing user interactivity and analytical depth.],[Integrated live data from Google Drive and implemented time-based metrics, enabling real-time performance monitoring for trend analysis and resolved geo-mapping issues by debugging latitude-longitude ID conflicts.],[Worked on predictive modeling \(linear regression, classification, time series\)],)
  ],
)
...
#two-col-entry(
  left-content: [
    #link("https://www.linkedin.com/company/jol-energy/posts/?feedView=all")[#strong[Data Analyst, Intern]], Jol Energy -- Vellore, TN, India
  ],
  right-content: [
    Aug 2025 – present
  ],
...
#one-col-entry(
  content: [
    #v(design-highlights-top-margin);#highlights([Focused on providing data driven development, analysis and visulaization.],)
  ],
)
...
#two-col-entry(
  left-content: [
    #link("https://www.linkedin.com/in/jayacharan-r/details/honors/")[#strong[Winner - Roboverse Ideathon 2025]] 
  ],
  right-content: [
    Jan 2025
  ],
...
#one-col-entry(
  content: [#strong[Programming:] Python, Java, C, C++, Bash, YAML, HTML, CSS, JavaScript]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[Operating System:] Arch Linux User , Windows]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[Software:] SAP Analytics Cloud, Excel, Sheets]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[Language:] English \(Professional proficiency\), Tamil \(Native proficiency\), Japanese & Hindi \(Limited proficiency\)]
)
...
#two-col-entry(
  left-content: [
    #link("https://coursera.org/share/1d2bc530c51ff9409bd374dd4c0bc853")[#strong[Microsoft AI & ML Engineering Professional Certificate]] 
  ],
  right-content: [
    July 2025
  ],
...
#one-col-entry(
  content: [
    #two-col(left-column-width: design-highlights-summary-left-margin, right-column-width: 1fr, left-content: [], right-content: [#v(design-highlights-top-margin);#align(left, [Microsoft])], column-gutter: 0cm)
  ],
)
...
#two-col-entry(
  left-content: [
    #link("https://www.boot.dev/certificates/a83f6559-1c33-49d4-a671-4c1aad44a89b")[#strong[Learn SQL]] 
  ],
  right-content: [
    Aug 2024
  ],
...
#two-col-entry(
  left-content: [
    #link("https://coursera.org/share/2f61af0cd7e024d55bbcdd1379f4cd4e")[#strong[Introduction to Git and GitHub]] 
  ],
  right-content: [
    June 2024
  ],
...
#one-col-entry(
  content: [
    #two-col(left-column-width: design-highlights-summary-left-margin, right-column-width: 1fr, left-content: [], right-content: [#v(design-highlights-top-margin);#align(left, [Google])], column-gutter: 0cm)
  ],
)
